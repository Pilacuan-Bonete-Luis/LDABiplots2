...
sidebar <- shinydashboard::dashboardSidebar(
  ...
  shinydashboard::sidebarMenu(
    ...
    shinydashboard::menuItem("LDA,Biplot and PESTEL",
                             tabName = "tab4",
                             icon = icon("desktop"),
                             ...
                             shinydashboard::menuSubItem("HJ-Biplot_PESTEL",
                                                         tabName = "tab43"
                             )
...
tabItem(tabName = "tab43",shinydashboard::box(
  width = 12,
  title = "Biplot_PESTEL",
  status = "primary",
  solidHeader = TRUE,
  ...
  sidebarPanel(
    ...
    conditionalPanel(
      condition = "input.Runpestel != 0" ,
      helpText(h3("Options to Customize the biplot")),
      selectInput("themepestel", " Theme",
                  choices = names(themesb)
      ),
      numericInput(
        inputId = "axisxpestel",
  ...
  mainPanel(
    tabsetPanel(
      tabPanel("HJ-Biplot_PESTEL",
               plotOutput("plotPestel"),
               radioButtons("butdownpestel",
                            "Select the Option",
                            choices = list("png","pdf")),
               downloadButton("downpestel",
                              label = "Download the plot"),
               br(),br(),
               helpText(
                 h4("Eigenvalues / Variances")),
               DT::DTOutput ("eigenv"),
               helpText(
                 h4("Coordinates for the variables")),
               DT::DTOutput ("hjcoordvar"),
               br(),br(),
               helpText(
                 h4("Quality of representation for variables")),
               DT::DTOutput ("hjvarcos2"),
               br(),br(),
               helpText(
                 h4("Coordinates for the individuals")),
               DT::DTOutput ("hjcoorind"),
               br(),br(),
                helpText(
                 h4("Quality of representation for variables")),
               DT::DTOutput ("hjindcos2")
               ),
      tabPanel("PESTEL_topics",
               plotOutput("plotPestel2"),
               radioButtons("butdownpestel2",
                            "Select the Option",
                            choices = list("png","pdf")),
               downloadButton("downpestel2",
                              label = "Download the plot")
               ),
      tabPanel("PESTEL_Factors",
               selectInput("typepestel", " Select",
                           choices = c("technology",
                             "political",
                             "economic",
                             "environmental",
                             "legal",
               ...
               plotOutput("plotPestel3"),
               radioButtons("butdownpestel3",
                            "Select the Option",
                            choices = list("png","pdf")),
               downloadButton("downpestel3",
                              label = "Download the plot"))
    )
